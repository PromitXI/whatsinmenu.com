...
- **Images:** all live files are catalogued and a reusable-image discovery database exists; missing and newly swapped dishes still require a reviewed photo before they can replace the placeholder.
...
5. Visual review and approval of discovered photos, plus visible attribution for externally sourced images.
