import { DEFAULT_PREFERENCES, buildMenu, formatDate, normalizePreferences, todayInKolkata } from "./menu-engine.js?v=5";
...
try {
  const response = await fetch("../data/dishes.json?v=5", { cache: "no-store" });
